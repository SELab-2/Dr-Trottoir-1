...
export class Building implements TableEntity<Building>{
  ...
  static headers(): Array<Header<Building>> {
    return [
      { id: 0, name: "Naam", fit: false, get: (e: Building) => e.name, type: RowType.TEXT, sortable: true },
      { id: 1, name: "Adres", fit: false, get: (e: Building) => e.address, type: RowType.TEXT, sortable: true },
