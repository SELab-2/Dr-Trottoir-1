...
export class Routes implements TableEntity<Routes>{
  ...
  static headers(): Array<Header<Routes>> {
    return [
      { id: 0, name: "Naam", fit: false, get: (e: Routes) => e.name, type: RowType.TEXT, sortable: true },
      { id: 1, name: "Gebouwen", fit: false, get: (e: Routes) => e.buildings, type: RowType.TEXT, sortable: true },
