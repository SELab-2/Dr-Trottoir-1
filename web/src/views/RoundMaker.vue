            ...
            <v-list width="100%">
              ...
              >
                ...
                <template v-slot:prepend>
                  <v-icon
                    icon="mdi-chevron-up"
                    @click="moveBuildingUp(i, building)"
                  ></v-icon>
                  <v-icon
                    icon="mdi-chevron-down"
                    @click="moveBuildingDown(i, building)"
                  ></v-icon>
                  <v-icon
                    icon="mdi-close"
...
export default {
  setup() {
     ...
     *
     * TODO: when editing a round this could change
     * We could give the list via props for editing it
     */
